...
class ProductBase(BaseModel):
    ...
    boxes_per_lot: Optional[int] = Field(None, gt=0, description="Nb de caisses = 1 lot (vente en gros). Laisse vide si non applicable.")
...
class ProductUpdate(BaseModel):
    ...
    boxes_per_lot: Optional[int] = Field(None, gt=0)
    unit_cost: Optional[Decimal] = Field(None, ge=0)
